...
const CaregiverHomeScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.card} onPress={() => showFeatureToast('Patient Monitoring')}>
        <Text style={styles.cardText}>Patient Monitoring</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.card} onPress={() => showFeatureToast('Medication Support')}>
        <Text style={styles.cardText}>Medication Support</Text>
      </TouchableOpacity>
